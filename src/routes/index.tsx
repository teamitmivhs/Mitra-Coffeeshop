      ...
      <section className="relative overflow-hidden">
        ...
        <div className="relative hidden min-h-[90svh] flex-col justify-between pb-14 pt-8 lg:flex">
          ...
          <div className="relative z-10 mx-auto flex w-full max-w-7xl items-center justify-between px-10">
            ...
            <span className="inline-flex items-center gap-2 rounded-full border border-green-500/30 bg-green-500/10 px-4 py-2 text-xs font-bold uppercase tracking-[0.18em] text-green-400 backdrop-blur-md">
